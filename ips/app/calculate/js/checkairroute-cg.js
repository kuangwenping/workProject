...
BUI.use(['bui/grid','bui/data'],function(Grid,Data){
    var Store = Data.Store,
        ...
        data = [{a: '123', b: 'edd'}, {a: 'cdd', b: 'edd'}, {a: 'cdd', b: 'edd'},{a: '1333', c: 'eee', d: 2},{a: '1333', c: 'eee', d: 2},{a: '1333', c: 'eee', d: 2},{a: '1333', c: 'eee', d: 2}, {a: '1333', c: 'eee', d: 2}];
    var store = new Store({
            data : data
        }),
        grid = new Grid.Grid({
...
$('.bui-grid-body').mCustomScrollbar({
    ...
    callbacks:{
        whileScrolling:function(){
            var draggerTop = this.mcs.draggerTop;
            var top = this.mcs.top;
            $draggers.each(function(i,dragger){
                console.log(dragger);
                var $dragger = $(dragger);
                $dragger.css('top',draggerTop);
                $($container[i]).css('top',top)
            });
        }
    }
});
var $draggers =  $('.mCSB_dragger');
