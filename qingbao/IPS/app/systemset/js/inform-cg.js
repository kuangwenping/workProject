...
BUI.use(['bui/grid','bui/data','bui/toolbar'],function(Grid,Data,Toolbar){
    var Store = Data.Store,
        columns = [
            ...
            return '<span class="grid-command btn1" id="editorBtn"> <i class="ui-icon ui-icon-editor"></i>编辑</span><span class="grid-command btn2"><i class="ui-icon ui-icon-stick"></i>置顶</span> <span class="grid-command btn2"><i class="ui-icon ui-icon-del1"></i>删除</span>';
    }},
        ],
        data = [
