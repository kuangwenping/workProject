    ...
    Main.prototype={
        ...
        _initNav : function(){
            ...
            $(_this.config.navConfig).each(function(index,v){
                ...
                navEl= '<li id="J'+v.id+'Nav" data-nav-i = "'+index+'" data-id="'+v.id+'">' +
                    ...
                    $(I).each(function(index,m){
                        ...
                        if(m.items && m.items.length > 0){
                            menuEl = '<li id="J'+m.id+'Muen" class="pull-down-wrp" data-menu-i = "'+index+'">'+
                                '<a class="down-menu-btn" href="javascript:;">'+m.text+'<i class="ui-icon ui-icon-down"></i>' +
                                '</a>' +
                                '<ul class="pull-down-menu" id="J-itemsWap"></ul>'+
                                '</li>'
                            items.push(m.items);
                        }else{
                            items.push(false);
