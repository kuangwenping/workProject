    ...
    var Store = Data.Store,
        columns = [
            ...
            {title : '操作',dataIndex :'d', width:'25%',renderer : function (value,obj) {
                return '<span class="grid-command btn1" id="editorBtn"> <i class="ui-icon ui-icon-editor"></i>编辑</span><span class="grid-command btn2"><i class="ui-icon ui-icon-del1"></i>删除</span>';
            }},
        ],
        data = [
